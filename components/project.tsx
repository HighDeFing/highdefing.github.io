        ...
        >
            <section
                ...
                <div
                    ...
                    <a href={githubUrl} target="_blank" rel="noopener noreferrer" className="mt-4">
                        <button className="flex items-center bg-gray-800 text-white px-3 py-1 rounded-full hover:bg-gray-700 transition">
